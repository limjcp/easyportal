...
export const seedPortalTileSettings: PortalTileSettings = {
...
export const seedPortalModules: PortalModuleConfig[] = [
...
export const seedCustomPortalTiles: CustomPortalTile[] = [];
