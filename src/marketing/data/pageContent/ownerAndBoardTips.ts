...
export const ownerAndBoardTipsPageContent: MarketingPageContent = {
  pageEyebrow: "Everything Condo",
  pageTitle: "Owner and Board Tips",
  pageIntro:
    "Practical guidance for directors, owners, and condo leaders who want more **confidence in decision-making**. Get management insights, **governance reminders**, and communication strategies that help boards and owners stay aligned.",
  pageActions: [{ label: "Subscribe to Updates", href: "/contact-us", variant: "primary" }],
  blocks: [
    {
      kind: "feature-grid",
