...
export const ebookPageContent: MarketingPageContent = {
  pageEyebrow: "Education Resource",
  pageTitle: "Free eBook",
  pageIntro:
    "A practical guide for boards evaluating **self-management vs professional condominium management**. Technically yes, boards can self-manage — but successful self-governance requires **sustained operational capacity**, legal awareness, and communication discipline.",
  blocks: [
    {
      kind: "section",
