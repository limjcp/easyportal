...
export const contactUsPageContent: MarketingPageContent = {
  pageEyebrow: "Start the conversation",
  pageTitle: "Contact Us",
  pageIntro:
    "Tell us about your community and what support you need. We respond **quickly** and keep conversations **confidential**. Whether you are evaluating management options, handling recurring service issues, or planning a transition, our team can help you **map the next step**.",
  pageActions: [{ label: "Book Free Consultation", href: "/free-consultation", variant: "primary" }],
  blocks: [
    {
      kind: "feature-grid",
